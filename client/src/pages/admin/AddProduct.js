        ...
        <Grid container spacing={10}>
          ...
          <Grid item md={6}>
            <Box square sx={{ height: "100%" }}>
              <Box sx={{ p: 5 }}>
                <h1 style={{ textAlign: "center",fontWeight:'100'}}>Add Product</h1>
                ...
                />
                <Button fullWidth variant="contained" sx={{ bgcolor: "black", color: "white" }} onClick={handleAddProduct}>Add</Button>
